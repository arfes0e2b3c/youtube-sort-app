<template>
  <div class="container">
    ...
    />
    <SearchChannel
      v-show="isSearchChannelShow"
      :YouTubeKey="YouTubeKey"
      @closeSearchChannel="closeSearchChannel"
      @setChannelId="setChannelId"
    />
    <div class="sort-search-bar">
      <button class="search-toggle-button" @click="toggleSearchList">
        検索する
    ...
    <div class="search-list">
      ...
      <div class="date-pickers">
        <DatePicker
          :language="ja"
          v-model="selectedParams.publishedAfter"
          class="date-picker"
          format="yyyy-MM-dd"
        />
        <p>〜</p>
        <DatePicker
          :language="ja"
          v-model="selectedParams.publishedBefore"
          class="date-picker"
          format="yyyy-MM-dd"
        />
      </div>
    ...
    <transition-group tag="ul" name="flip-list" :class="{ toggled: isToggled }">
      <li v-for="video in videos" :key="video.id">
        ...
        <p class="statistics">
          {{ video.statistics.viewCount }}回視聴・{{
            video.statistics.likeCount
          }}Like・{{ video.statistics.commentCount }}コメント
        </p>
      ...
      videos: [
        {
          ...
          snippet: {
            ...
            title: "た",
            description:
              "今回から過去最長シリーズの「た」が始まります！当チャンネルが始まって以来最大の難問に２人はどう立ち向かっていくのでしょうか！",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "今回は大好評発売中の堀元の処女作『教養悪口本』にあやかってインテリ悪口パビリオンを開催（？）しました！このラジオを始めてから水野 ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "以前視聴者から募集したうんちくクイズがついに動画化！皆さんやたらとハイレベルな問題を送ってきてくれているのですが、はたして全問 ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "明けましておめでとうございます！本日は新年らしく今年の抱負を語りました。 ゆるい雑談回かと思いきや、超絶本気の告知がラストに ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            channelId: "UCmpkIzF3xFzhPez7gXOyhVg",
            title:
              "ゆる言語学ラジオ忘年会ライブ【流行語大賞決定&amp;ひたすらエモい話】",
            description:
              "ゆる言語学ラジオの忘年会ライブです。10万人突破記念ライブも兼ねてるよ！！絶対皆リアルタイムでコメントしてくれな！！！ 告知動画 ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "雑談回。勉強すればするほど「オレ、これを知らないんだな」と自覚するし疑問の量が増えるので、むしろ無知の量で競うべきなのではないか ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "前回に引き続いて無限語源トークの2回目。水野曰く魚たちはそれぞれの特徴から名付けられているらしいのですが、アジは「味が良い」から ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "今回は「無限語源トーク」の1回目。水野が延々と単語の語源を言うなか、隣の深読みおじさんが「あいみょん ＝ 語源オタク説」を唱えだしたり ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "前回に引き続き、今回も福田先生ゲスト雑談回！今回は言語学者になった理由や高校生時代の話など福田先生自身のお話を多く伺って ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "まだまだ福田先生ゲスト回は終わりません！今回は雑談回ということで水野が暴走気味に福田先生を言語学分野で質問攻めにしています。",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "今回は忘年会ライブの告知です。年末のお祭り騒ぎに乗じて、「ゆる言語学ラジオの流行語大賞」「2人の出会いなど、エモめの話」を語り ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "第二言語習得論ラスト回。「アラビア語話者は数直線が逆になる」「スペイン語だと解けるのにスウェーデン語だと解けない問題」「自販機で ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "今回は福田先生ゲスト回の2回目。明かされる衝撃の事実、なんと英語はあの衛星枠付言語だったのです。 【目次】 00:00 オープニング。",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "ついにこのチャンネルに言語学者が降臨しました。いつもよりも更に濃い内容となっておりますが、2人とは少し違ったガチの学者ならではノリ ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "左右を持たず、東西南北でのみ位置を示す言語があるそうです。それを使う民族はその分我々よりも位置感覚が優れていたりするのでしょ ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "今回のテーマは「第二言語習得論」。第二言語を習得する時の脳内について扱う学問ジャンルだそうです。すごく役立つ話が聞けそうな ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "「サポーターコミュニティ始めるよ！」という告知回です。 お気持ちで投げ銭をいただければ、伝説のボツ回「水野が難読漢字を書き取りする ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "温泉旅館に来ました。浮かれてなぜか冒頭にVlogを挟みつつ、途中からいつものラジオになります。与謝野晶子はトルストイを読んで○○に ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "大人気企画（？）のミーム提案委員会が帰ってきました。 今回は共感必至のあるあるミームからリスナーから送られてきたミームまで幅広く ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "おもしろ単語シリーズ、ラストです。今回のテーマは「悪口」。 「匿名の三流作家」「持説に惚れ込んでいる人」「出しゃばりな批評家」など、 ...",
            thumbnails: {
              default: {
            ...
            omittedTitle:
              "説教おじさんスイッチが反応しちゃう英単語【OEDおもしろ単語...",
          },
          videoId: "-d742iuB7L0",
          contentDetails: {
            duration: "47:44",
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "前回に続き、「おもしろ単語」紹介シリーズ。痴漢の話をしたくなる単語やサーフィンのコスパの悪さを語りたくなる単語など、色々出てくるよ！",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "大型辞書を丸一年かけて全部読んだ人の本」を読んで、おもしろかった場所をまとめました。全然理解できないあるあるや、一生使わない ...",
            thumbnails: {
              default: {
            ...
            omittedTitle:
              "1年間辞書を読み続けた人にしか分からないあるある【OEDおも...",
          },
          videoId: "b5-G9dzdLzI",
          contentDetails: {
            duration: "35:20",
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "今回は三省堂の今年の新語2021に便乗してみました。実際に選ばれそうなものから絶対に選ばれそうにないものまで、いろいろな案が出た ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "ゆるコンピュータ科学ラジオ最終回。これまで見てきたプログラミング言語に関する解説をフル活用して「プログラミング言語は言語なのか？",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "ゆるコンピュータ科学ラジオも早3回目。今回はプログラミング言語に宿る思想について見ていきます。プログラミング言語も思想によって進化 ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "プログラマーとは何をしている人たちなのでしょうか？彼らが普段パソコンに向かって行っている作業が何なのかを知れば、自ずと ...",
            thumbnails: {
              default: {
            ...
            omittedTitle:
              "プログラマーと辞書オタク、実質同じ【ゆるコンピュータ科学ラジ...",
          },
          videoId: "uDCTXGCk2Zk",
          contentDetails: {
            duration: "39:23",
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "今回は「ゆるコンピュータ科学ラジオ」です。以前出た「プログラミング言語は言語か？」みたいな話をするために、プログラミング言語について ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "文教堂で実施してくれた「ゆる言語学ラジオフェア」、実際に店舗に行って撮影してきました。フェアの様子をお伝えしつつ、「生成文法の本 ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            channelId: "UCmpkIzF3xFzhPez7gXOyhVg",
            title:
              "人類の多くはベンジャミン。生まれた瞬間〇〇を判断【英米人名２】#61",
            description:
              "今回は前回に引き続き「英米人名語源」がテーマです。語源を知れば、あの名前とこの名前が同一のものだと分かったり、自分がベンジャミン ...",
            thumbnails: {
              default: {
            ...
            omittedTitle:
              "人類の多くはベンジャミン。生まれた瞬間〇〇を判断【英米人名２...",
          },
          videoId: "SbV9O7Gd4Sk",
          contentDetails: {
            duration: "44:31",
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "今回のテーマは「英米人名語源」。ウィリアムは「決意の兜」を意味するし、アタナシウスは「不死」を意味するそうです。鬼滅の刃に「不死川」 ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "今回は久しぶりのコメント返し回……のはずが、筒井康隆の短編の話が止まらなくなってしまっています。仕方がないのです。2人とも筒井 ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "サピア撮り終わり雑談回。「太宰治が推奨してるクリエイティブの引き算」「江戸時代の米はビットコインのように価格が乱高下した」「富士そば ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "言語の変化は5ステップで説明できる」「子音が17個連続する言語がある！？」など、サピアの著書の『言語』から面白そうなところを集めてき ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "「けしからん！」と言われがちな「ら抜き言葉」ですが、実は美しい日本語への変化なのかもしれません。 エドワード・サピアの指摘した「 ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "サピアを大いに悩ませた英文“Whom did you see”。文法的には正しいはずのこの文をネイティブは気持ち悪く感じてしまうそうです。 我々に ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "今回のテーマは「エドワード・サピア」。今まで扱ってきた言語学者達と比べても異質の存在です。彼の説いた「人間に音声器官は存在 ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "新コーナー「うんちくエウレーカクイズ」です。「ナチスに絵を売って英雄になるってどういうこと？」「国を戦争に負けさせる以上の重罪って？",
            thumbnails: {
              default: {
            ...
            omittedTitle:
              "人類が服を着始めた年代は、あの虫から分かる【うんちくエウレー...",
          },
          videoId: "LteliiwAFe4",
          contentDetails: {
            duration: "32:30",
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "「オックスフォード英語大辞典」シリーズの続き。今回はとうとう最大の協力者である殺人犯が登場します。「自分が殺した人の奥さんとの奇妙 ...",
            thumbnails: {
              default: {
            ...
            omittedTitle:
              "妄想で人を撃ち、自分のアレを切り落とした狂人の皮肉【オックス...",
          },
          videoId: "O9dMmofn7JU",
          contentDetails: {
            duration: "35:41",
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "今回のテーマは「オックスフォード英語大辞典」。「熱心な協力者が殺人犯だった」「編集主幹は牛にラテン語を教えていた」「完成まで70年 ...",
            thumbnails: {
              default: {
            ...
            omittedTitle:
              "世界初の大型辞書は、殺人犯のお陰で完成した【オックスフォード...",
          },
          videoId: "e11Q7m-45Cc",
          contentDetails: {
            duration: "34:07",
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "文教堂あきる野とうきゅう店さんとコラボで、「ゆる言語学ラジオフェア」をやることになりました。皆さんぜひ足を運んでくださいね！&フェアに ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "『数の発明』シリーズ最終回。「数と言葉は両方とも身体をハックして生まれた」「数がなければ文字もなかった？」「自分の理解度に応じた ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "『数の発明』シリーズの続き。今回は「10進法はなぜ発明されたのか？」「12進数の方が便利じゃね？」「人類が巨大な数を必要とした ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "今回のテーマは『数の発明』。「人間は数を本能的に持っているのか？それとも文化的に習得するのか？」という疑問に取り組んだケイレブ・ ...",
            thumbnails: {
              default: {
            ...
            omittedTitle:
              "人は生まれつき算数ができる？赤ちゃんビビらす実験とは【数の発...",
          },
          videoId: "jrNc7fmtTNE",
          contentDetails: {
            duration: "28:16",
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "新コーナー「何こいつキモナイト」です。「ケレスとバッカスがいないとヴィーナスが凍えてしまう」「ディオゲネスの樽」など、普通に使うとキモい ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "前回に引き続き、「文型」です。「存在しない動詞も文型で理解できる」「あげる・もらう・妬むの共通点」「物理をマスターしたニュアンスがあるの ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "今回のテーマは「文型」。高校英語で習ったアレ、何の役にも立たないと思ってませんか？なんと、文型さえ分かれば動詞の意味が推測 ...",
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              '雑談コメント返し回。「seasonはなぜ季節と味付けを表す？」「"便"はなぜ手紙とうんこを表す？」「Dr.Stoneは語源で見せ場を作ってる ...',
            thumbnails: {
              default: {
        ...
        },
        {
          ...
          snippet: {
            ...
            description:
              "長大な「助数詞」シリーズを撮り終えた達成感で、振り返り雑談回をやりました。「プルーストにはない週刊連載の強み」「ピダハンと喧嘩商売 ...",
            thumbnails: {
              default: {
      ...
      sortButtons: [
        {
          title: "新しい順",
          standard1: "snippet",
          standard2: "publishedAt",
          selected: true,
          id: 1,
        },
        {
          title: "高評価順",
          standard1: "statistics",
          standard2: "likeCount",
          selected: false,
          id: 2,
        },
        ...
        },
        {
          title: "コメント数順",
          standard1: "statistics",
          standard2: "commentCount",
          selected: false,
          id: 4,
        },
        {
          title: "動画時間順",
          standard1: "contentDetails",
          standard2: "duration",
          selected: false,
          id: 5,
        },
      ...
      if (this.pass === "pass") {
        ...
        for (let i = 0; i < that.videoIds.length; i++) {
          ...
          await this.$axios
            ...
            .then(function (response) {
              that.videoIds[i].snippet.omittedTitle = that
                .omitTitle(that.videoIds[i].snippet.title)
                .split("&amp;")
                .join("&");
              response.items[0].contentDetails.duration = that.modifyISO(
      ...
      if (s3) {
        ...
        this.videos.sort(function (a, b) {
          if (s2 === "publishedAt") {
            ...
            return (
              b[s1][s2].split(":").join("") - a[s1][s2].split(":").join("")
            );
          } else {
